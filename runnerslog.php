...
^^ will either be 'miles' or 'meters'
defaults to 'meters' upon plugin activation

note the field name changes in runners_log_basic!
...
*/
 ...
 //Get the distance
	$meters = get_post_meta($post->ID, "_rl_meters_value", $single = true);
