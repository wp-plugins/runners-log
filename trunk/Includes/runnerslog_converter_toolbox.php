...
<h2>Calculate Race Time</h2>
	<table class="form-table">
		<tbody>
			<tr valign="top">
				<th scope="row"><label for="runnerslog_convert_racetime_distance"><?php _e('Distance:') ?></label></th>
				<td><?php
					if ( $distancetype == meters ) {
			...
			<tr valign="top">
				<th scope="row"><label for="runnerslog_convert_racetime_speed"><?php _e('Speed:') ?></label></th>
				<td><?php
...
<h2>Calculate Distance</h2>
	<table class="form-table">
		<tbody>
			<tr valign="top">
				<th scope="row"><label for="runnerslog_convert_distance_time"><?php _e('Time:') ?></label></th>
				<td><?php
						...
						echo '<span class="description"> Must be formated as hh:mm:ss like 01:37:45 for 1 hours 37min and 45sec</span>';
					?>
				</td>
			</tr>
			<tr valign="top">
